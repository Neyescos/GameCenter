...
exports.PlayingSpacesService = void 0;
var sql = require("msnodesqlv8");
var connectionString = "server=.;Database=GameCenter;Trusted_Connection=Yes;Driver={SQL Server Native Client 11.0}";
var query = "SELECT * FROM [GameCenter].[dbo].[PlayingSpaces]";
var res;
var PlayingSpacesService = /** @class */ (function () {
    function PlayingSpacesService() {
    }
    PlayingSpacesService.prototype.get = function () {
    ...
    PlayingSpacesService.prototype.getRes = function () {
        return res;
    };
    PlayingSpacesService.prototype.post = function (obj) {
        try {
            var postquery = "insert into PlayingSpaces values('" + obj.IsEmpty + "','" + obj.Gaming_DeviceId.toString() + "')";
    ...
    return PlayingSpacesService;
}());
exports.PlayingSpacesService = PlayingSpacesService;
